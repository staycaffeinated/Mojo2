 ...
 * Unit tests
 */
class SpringWebMvcEndpointGeneratorTests {

    Generator generatorUnderTest;

    @BeforeEach
    public void setUpEachTime() {
        generatorUnderTest = new SpringWebMvcEndpointGenerator();
     ...
     */
    @Test
    void shouldContainLexicalScope() throws Exception {
        // set up
    ...
    private Map<String,Object> buildSampleLexicalScope() {
        ...
        // In real world, these are from mojo.properties file
        lexicalScope.put(ProjectKeys.FRAMEWORK, SupportedFramework.WEBMVC );
        lexicalScope.put(ProjectKeys.BASE_PATH, "/home");
        lexicalScope.put(ProjectKeys.APPLICATION_NAME, "webmvc-service");
        lexicalScope.put(ProjectKeys.BASE_PACKAGE, "org.example.mvc");
        lexicalScope.put(ProjectKeys.GROUP_ID, "org.example.webmvc");

        // In real world, these are from the command line
        lexicalScope.put(EndpointKeys.CMDLINE_RESOURCE_ARG, "Person");
        lexicalScope.put(EndpointKeys.CMDLINE_ROUTE_ARG, "/person");
    ...
    private Map<String,Object> buildSampleCommandLineInputs() {
        ...
        commandLineInputs.put(EndpointKeys.CMDLINE_RESOURCE_ARG, "Person");
        commandLineInputs.put(EndpointKeys.CMDLINE_ROUTE_ARG, "/person");
    ...
    private Configuration buildSampleConfiguration() throws Exception {
        ...
        updateEnv(ProjectKeys.BASE_PACKAGE, "org.example.mvc.personnel");
        updateEnv(ProjectKeys.BASE_PATH, "/personnel/api/v1");
        updateEnv(ProjectKeys.FRAMEWORK, SupportedFramework.WEBMVC.toString());
